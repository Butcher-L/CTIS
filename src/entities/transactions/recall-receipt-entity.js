const makeRecallReceiptEntity = ({}) => {
    return function makeRecallReceipt({
        recallReceiptNumber, description, receivedFrom, receivedBy, controlCount, controlAmount, checks
    }){
        if(!recallReceiptNumber){
            throw new Error('no recall receipt number provided');
        };
        ...
        return Object.freeze({
            getRecallReceiptNumber: () => recallReceiptNumber,
...
module.exports = makeRecallReceiptEntity;