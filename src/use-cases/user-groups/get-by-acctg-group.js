const getByAcctgGroupUseCase = ({ userGroupsDb, userGroups }) => {
    return async function get(id,SessionId){

        const fetched = await userGroups.selectByUserGroups(id,SessionId)
        ...
        return data
        // const fetched = await userGroupsDb.getByAcctgGroup(id);
        // return fetched.rows;
    };
};

module.exports = getByAcctgGroupUseCase;