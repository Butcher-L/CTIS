...
const transferredChecksReportUseCase = ({ reportsDb, getCheckTrailUseCase, reports }) => {
    return async function get(dateRange, SessionId) {
        ...
        const result = []
        const fetch = await reports.getTransferredChecksReport(dateRange, SessionId);
...
module.exports = transferredChecksReportUseCase;