...
const staledChecksReport = ({ reportsDb, getCheckTrailUseCase, reports }) => {
    return async function get(dateRange, SessionId){
        ...
        const result = []
        const fetch = await reports.getStaledChecksReport(dateRange, SessionId);
...
module.exports = staledChecksReport;