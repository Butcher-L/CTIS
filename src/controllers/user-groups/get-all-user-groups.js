const getAllUserGroupsController = ({ getAllUserGroupsUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getAllUserGroupsUseCase(SessionId);
...
module.exports = getAllUserGroupsController;