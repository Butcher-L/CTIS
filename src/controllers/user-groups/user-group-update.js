const updateUserGroupController = ({ updateUserGroupUseCase }) => {
    return async function put(httpRequest){
        try{
            ...
            const put = await updateUserGroupUseCase(id, info,SessionId);
...
module.exports = updateUserGroupController;