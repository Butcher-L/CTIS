const getAllAcctgGroupsController = ({ getAllAcctgGroupsUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getAllAcctgGroupsUseCase(SessionId);
...
module.exports = getAllAcctgGroupsController;