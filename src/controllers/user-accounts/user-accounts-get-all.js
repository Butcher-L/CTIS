const getAllUserAccountsController = ({ getAllUserAccountsUseCase }) => {
    return async function post(httpRequest){
        try{
            ...
            const fetched = await getAllUserAccountsUseCase(SessionId);
...
module.exports = getAllUserAccountsController;