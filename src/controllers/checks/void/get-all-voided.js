const getAllVoidedController = ({ getAllVoidedChecksUseCase }) => {
    return async function post(httpRequest){
        try{
            ...
            const fetched = await getAllVoidedChecksUseCase(httpRequest.query,SessionId);
...
module.exports = getAllVoidedController;