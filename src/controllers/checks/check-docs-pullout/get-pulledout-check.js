const getPulledoutCheckController = ({ getPulledoutCheckUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getPulledoutCheckUseCase(id,SessionId);
...
module.exports = getPulledoutCheckController;