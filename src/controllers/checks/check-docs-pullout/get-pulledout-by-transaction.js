const getPulledoutByTransactionController = ({ getPulledoutByTransactionUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getPulledoutByTransactionUseCase(transmitId,SessionId);
...
module.exports = getPulledoutByTransactionController;