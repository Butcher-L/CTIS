const getTransmittedCheckController = ({ getTransmittedCheckUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getTransmittedCheckUseCase(id,SessionId);
...
module.exports = getTransmittedCheckController;