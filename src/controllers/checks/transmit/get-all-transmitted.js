const getAllTransmittedController = ({ getAllTransmittedUseCase }) => {
    return async function post(httpRequest){
        try{
            ...
            const fetched = await getAllTransmittedUseCase(SessionId);
...
module.exports = getAllTransmittedController;