const getAllRecalledController = ({ getAllRecalledChecksUseCase }) => {
    return async function post(httpRequest){
        try{
            ...
            const fetched = await getAllRecalledChecksUseCase(httpRequest.query,SessionId);
...
module.exports = getAllRecalledController;