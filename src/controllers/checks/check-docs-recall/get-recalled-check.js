const getRecalledCheckController = ({ getRecalledCheckUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getRecalledCheckUseCase(id,SessionId);
...
module.exports = getRecalledCheckController;