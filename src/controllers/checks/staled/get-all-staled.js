const getAllStaledController = ({ getAllStaledChecksUseCase }) => {
    return async function post(httpRequest){
        try{
            ...
            const fetched = await getAllStaledChecksUseCase(httpRequest.query,SessionId);
...
module.exports = getAllStaledController;