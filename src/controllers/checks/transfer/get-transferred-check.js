const getTransferredCheckController = ({ getTransferredCheckUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getTransferredCheckUseCase(id,SessionId);
...
module.exports = getTransferredCheckController;