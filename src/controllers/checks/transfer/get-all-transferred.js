const getAllTransferredController = ({ getAllTransferredUseCase }) => {
    return async function post(httpRequest){
        try{
            ...
            const fetched = await getAllTransferredUseCase(SessionId);
...
module.exports = getAllTransferredController;