const getReturnedCheckController = ({ getReturnedCheckUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getReturnedCheckUseCase(id,SessionId);
...
module.exports = getReturnedCheckController;