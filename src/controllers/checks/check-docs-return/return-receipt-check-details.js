const getCheckReturnReceiptController = ({ getCheckReturnReceiptUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getCheckReturnReceiptUseCase(id,SessionId);
...
module.exports = getCheckReturnReceiptController;