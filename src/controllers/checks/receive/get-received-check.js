const getReceivedCheckController = ({ getReceivedCheckUseCase }) => {
    return async function get(httpRequest) {
        try {
            ...
            const fetched = await getReceivedCheckUseCase(id, SessionId);
...
module.exports = getReceivedCheckController;