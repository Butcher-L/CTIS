...
const getAllTransferTransactionsUseCase = ({ getAllTransferTransactionsUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getAllTransferTransactionsUseCase(httpRequest.query,SessionId);
