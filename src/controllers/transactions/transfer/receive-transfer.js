const receiveTransferTransactionController = ({ receiveTransferTransactionUseCase }) => {
    return async function put(httpRequest){
        try{
            ...
            const put = await receiveTransferTransactionUseCase({id, ...info},SessionId);
...
module.exports = receiveTransferTransactionController;