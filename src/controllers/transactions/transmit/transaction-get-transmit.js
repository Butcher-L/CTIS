const getTransmitTransactionController = ({ getTransmitTransactionUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getTransmitTransactionUseCase(id,SessionId,data);
...
module.exports = getTransmitTransactionController;