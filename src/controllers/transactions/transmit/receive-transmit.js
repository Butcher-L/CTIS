const receiveTransmittedTransactionController = ({ receiveTransmittedTransactionUseCase }) => {
    return async function put(httpRequest){
        try{
            ...
            const put = await receiveTransmittedTransactionUseCase({id, ...info},SessionId);
...
module.exports = receiveTransmittedTransactionController;