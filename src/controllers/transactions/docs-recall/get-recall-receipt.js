const getRecallReceiptController = ({ getRecallReceiptUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getRecallReceiptUseCase(id,SessionId,data);
...
module.exports = getRecallReceiptController;