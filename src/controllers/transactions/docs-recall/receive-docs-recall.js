const receiveDocsRecallTransactionController = ({ receiveDocsRecallTransactionUseCase }) => {
    return async function put(httpRequest){
        try{
            ...
            const put = await receiveDocsRecallTransactionUseCase({id, ...info},SessionId);
...
module.exports = receiveDocsRecallTransactionController;