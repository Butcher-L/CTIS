const getReturnReceiptController = ({ getReturnReceiptUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getReturnReceiptUseCase(data,SessionId);
...
module.exports = getReturnReceiptController;