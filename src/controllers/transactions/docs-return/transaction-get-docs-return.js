const getDocsReturnTransactionController = ({ getDocsReturnTransactionsUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getDocsReturnTransactionsUseCase(id,SessionId,data);
...
module.exports = getDocsReturnTransactionController;