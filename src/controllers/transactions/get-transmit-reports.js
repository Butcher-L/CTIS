...
const getAllTransmitReportsControllers = ({ getAllTransmitreportUseCase }) => {
    return async function get(httpRequest) {
        ...
        try {
            ...
            const fetched = await getAllTransmitreportUseCase(toView, SessionId);
            return {
                headers: {
                    "Content-Type": "application/json",
                },
...
module.exports = getAllTransmitReportsControllers