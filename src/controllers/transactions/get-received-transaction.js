const getReceivedTransactionsController = ({ getReceivedTransactionsUseCase }) => {
    return async function put(httpRequest){
        try{
            ...
            const fetched = await getReceivedTransactionsUseCase(info.transaction,info,SessionId);
...
module.exports = getReceivedTransactionsController;