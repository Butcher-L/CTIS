const getPulloutTransactionController = ({ getPulloutTransactionUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getPulloutTransactionUseCase(id,SessionId);
...
module.exports = getPulloutTransactionController;