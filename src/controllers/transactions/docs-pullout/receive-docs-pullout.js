const receivePulloutTransactionController = ({ receivePulloutTransactionUseCase }) => {
    return async function put(httpRequest){
        try{
            ...
            const put = await receivePulloutTransactionUseCase({id, ...info},SessionId);
...
module.exports = receivePulloutTransactionController;