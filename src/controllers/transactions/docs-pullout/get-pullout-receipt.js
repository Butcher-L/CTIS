const getPulloutReceiptController = ({ getPulloutReceiptUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getPulloutReceiptUseCase(id,SessionId,data);
...
module.exports = getPulloutReceiptController;