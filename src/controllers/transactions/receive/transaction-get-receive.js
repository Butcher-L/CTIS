const getReceiveTransactionController = ({ getReceiveTransactionUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getReceiveTransactionUseCase(id,SessionId,data);
...
module.exports = getReceiveTransactionController;