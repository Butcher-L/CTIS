const getAllReceiveTransactionsUseCase = ({ getAllReceiveTransactionsUseCase }) => {
    return async function get(httpRequest){
        try{
            ...
            const fetched = await getAllReceiveTransactionsUseCase(httpRequest.query,SessionId);
